...
export const HOLIDAY_REGISTRY: HolidayEvent[] = [
  {
    ...
    route: '/holiday-specials',  cuisineTags: ['Nigerian', 'West African', 'Middle Eastern'],
  },
  {
    ...
    route: '/holiday-specials',  cuisineTags: ['Soul Food', 'American'],
  },
  {
  ...
  },
  {
    ...
    route: '/holiday-specials',  cuisineTags: ['Hausa', 'Northern Nigerian'],
  },
  {
    ...
    route: '/holiday-specials',  cuisineTags: ['Canadian'],
  },
  {
    ...
    route: '/holiday-specials',  cuisineTags: ['Nigerian'],
  },
  {
    ...
    route: '/holiday-specials',  cuisineTags: ['Universal'],
  },
  {
    ...
    route: '/holiday-specials',  cuisineTags: ['American', 'Universal'],
  },
];
  ...
  if (rush && prefs.rush !== false) {
    ...
    if (shouldFireAlert(last, 2 * HOUR_MS)) {
      pending.push({
        ...
        route: role === 'buyer' ? '/specials' : '/prepper-hub',
        priority: 10,
