...
const EVENTS: HolidayEvent[] = [
  {
    id: 'eid', name: 'Eid al-Adha', flag: '☪️', date: 'Jun 16', daysAway: 4, color: '#16a34a',
    ...
    urgency: 'soon', culture: 'Muslim / West African',
  },
  {
  ...
  {
    id: 'fathers_day', name: "Father's Day", flag: '👨', date: 'Jun 15', daysAway: 3, color: ORANGE,
    ...
    urgency: 'today', culture: 'Universal',
  },
  {
    id: 'sallah', name: 'Sallah Day (Eid Kabir)', flag: '🌙', date: 'Jun 17', daysAway: 5, color: '#8b5cf6',
    ...
    urgency: 'soon', culture: 'Northern Nigerian',
  },
  {
    id: 'canada_day', name: 'Canada Day', flag: '🇨🇦', date: 'Jul 1', daysAway: 19, color: '#dc2626',
    ...
    urgency: 'upcoming', culture: 'Canadian',
  },
  {
    id: 'independence_ng', name: 'Nigerian Independence', flag: '🇳🇬', date: 'Oct 1', daysAway: 111, color: '#16a34a',
    ...
    urgency: 'upcoming', culture: 'Nigerian',
  },
];
